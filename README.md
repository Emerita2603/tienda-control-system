...
Sistema web para la gestión de una tienda pequeña, desarrollado con React y Firebase.  
Permite administrar productos, ventas, gastos y generar reportes en tiempo real.
